...
public class Decada10 extends JPanel {
	...
	public Decada10() {
		...
		jscroll.setViewportView(ponerTitulosEsp10());
	...
	public Component ponerTitulosEsp10(){
	...
	public Component ponerTitulosEng10(){
		SimpleAttributeSet sas = new SimpleAttributeSet(); 
  		StyleConstants.setBold(sas, true);
 		StyleConstants.setItalic(sas, true);
		StyleConstants.setFontSize(sas, 23);
		txtpnDecActual.getStyledDocument().setCharacterAttributes(231, 38, sas, false);
		txtpnDecActual.getStyledDocument().setCharacterAttributes(454, 34, sas, false);
		txtpnDecActual.getStyledDocument().setCharacterAttributes(2064, 28, sas, false);
		txtpnDecActual.getStyledDocument().setCharacterAttributes(3078, 21, sas, false);
		txtpnDecActual.getStyledDocument().setCharacterAttributes(4192, 27, sas, false);
		txtpnDecActual.getStyledDocument().setCharacterAttributes(5543, 24, sas, false);
