...
public class ApiJSONQuiz{
	...
	private static String RESPUESTA="Respuesta";
	private static String MALA1="Respuesta_Mal1";
	private static String MALA2="Respuesta_Mal2";
	private static String MALA3="Respuesta_Mal3";
	 ...
	 */
	public void quizQuerry() {
		datos = new ArrayList <String[]>();
		try{
			//COPIAMOS LA URL DE NUESTRO SERVICIO
			URL url = new URL("http://gamequiz.esy.es/consultas/api.php?accion=quiz"); 
			//ABRIMOS LA URL
			...
			//SACAMOS UN ARRAY DE NUESTRO OBJETO DONDE ESTAN TODAS NUESTRAS CONSULTAS
			...
			for(int x = 0; x<data.size(); x++){
				...
				for(int e = 0; e<titulos.length;e++){
					...
					if(e==0) nombre=data1.getString(titulos[e]);
				}
